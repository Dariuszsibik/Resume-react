  ...
  <section className="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        ...
        <div className="subheading mb-3">Z czego korzystam:</div>
          ...
          <ul className="icon-container">
            ...
            <li  className="icon-single-container">
              <span  >
                <i className="icon-i-image devicon-vuejs-plain colored"></i>
                <h3 className="icon-h3-title ">vuejs</h3>
              </span>
            </li><li  className="icon-single-container">
              <span  >
            ...
            <li  className="icon-single-container">
              <span  >
                <i className="icon-i-image devicon-docker-plain colored"></i>
                <h3 className="icon-h3-title ">docker</h3>
              </span>
            </li>
            <li  className="icon-single-container">
              <span  >
                <i className="icon-i-image devicon-angularjs-plain colored"></i>
                <h3 className="icon-h3-title ">angularjs</h3>
              </span>
            </li>
            <li  className="icon-single-container">
              <span  >
