        ...
        <section className="resume-section p-3 p-lg-5 d-flex d-column">
          <div className="my-auto">
            ...
            <div className="about-list subheading">
              ...
              <div className="about-list-item"> <span className="about-list-item-span">{t("about-tel")} </span>883 739 377
              </div>
              <div className="about-list-item"> <span className="about-list-item-span">Email: </span><a href="sibikdariusz@gmail.com"
                  className="about-email"> sibikdariusz@gmail.com</a> </div>
            </div>
            <p className="about-me lead mb-5">{t("about-me")} <br /> {t("about-free-time")}</p>
            <div className="about-icons">
              <a href="https://www.linkedin.com/in/dariusz-sibik-a14349104/" target="_blank" rel="noopener noreferrer"
                className="about-icon-linedin">
                <i className="fa fa-linkedin"></i>
              </a>
              <a href="https://github.com/Dariuszsibik" target="_blank" rel="noopener noreferrer" className="about-icon-github">
                <i className="fa fa-github"></i>
              </a>
              <a href="https://www.facebook.com/dariusz.sibik" target="_blank" rel="noopener noreferrer" className="about-icon-facebook">
